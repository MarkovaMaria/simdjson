...
#ifndef SIMDJSON_IMPLEMENTATION_AVX512
#define SIMDJSON_IMPLEMENTATION_AVX512 (SIMDJSON_IS_X86_64)
#endif
#ifdef _MSC_VER
#define SIMDJSON_CAN_ALWAYS_RUN_AVX512 ((SIMDJSON_IMPLEMENTATION_AVX512) && (SIMDJSON_IS_X86_64) && (__AVX512__))
#else
#define SIMDJSON_CAN_ALWAYS_RUN_AVX512 ((SIMDJSON_IMPLEMENTATION_AVX512) && (SIMDJSON_IS_X86_64) && (__AVX512__) && (__BMI__) && (__PCLMUL__) && (__LZCNT__))
#endif
